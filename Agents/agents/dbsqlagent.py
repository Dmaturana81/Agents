...
# %% ../../nbs/01_Databricks_text2sql.ipynb 19
...
# %% ../../nbs/01_Databricks_text2sql.ipynb 24
...
# %% ../../nbs/01_Databricks_text2sql.ipynb 35
@classmethod
@patch
def row_2_str(
...
# %% ../../nbs/01_Databricks_text2sql.ipynb 37
@classmethod
@patch
def list_cols(
        cls:Connection_db, # self object
...
# %% ../../nbs/01_Databricks_text2sql.ipynb 58
def get_columns(
        state: State # state of the graph
        ) -> State: # dictionary with the state of the message
...
# %% ../../nbs/01_Databricks_text2sql.ipynb 85
def write_sql(
        state: State # state of the graph
        ) -> State: # dictionary with the state of the message
...
# %% ../../nbs/01_Databricks_text2sql.ipynb 90
...
# %% ../../nbs/01_Databricks_text2sql.ipynb 92
def final_answer(
        state: State # state of the graph
        ) -> State: # dictionary with the state of the message
    """
...
# %% ../../nbs/01_Databricks_text2sql.ipynb 96
